...
print("Benim adım Dpğukan,", 20, "yaşındayım", 60, "kiloyum")

print("En yakın arkadaşım Kendim. Onunla", 20, "yıldır tanışıyorum")
...
print(25 >= 25) # true
print(50 < 15) # false
print("Doğukan" == "Doğukan") # false
print("Doğukan" != "mahir") # true
print(18 <= 17) # false
...
print(8 != 6 and 5 > 2 and "Doğukan" != "ali") # true
